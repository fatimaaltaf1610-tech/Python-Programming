...
while not valid:
    try:
        bill_amount, discount_percent, people = input("Enter the bill amount, the discount percentage, and the people seperated by commas: ").split(",")
        ...
        print("Invalid input! Enter values like thia: 1000, 10, 2")
        ...
        print("Disocunt check completed for this attempt.")
